...
typedef struct zone_info {
    ...
    /* Protection */
    mm_spinlock_t zone_lock;           /* Verrou de la zone */
} zone_info_t;
...
static mm_spinlock_t zone_mgr_lock = MM_SPINLOCK_INIT("unknown");
#define ZONE_MGR_LOCK() mm_spin_lock(&zone_mgr_lock)
#define ZONE_MGR_UNLOCK() mm_spin_unlock(&zone_mgr_lock)
#else
